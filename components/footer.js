...
<footer className="bg-nero w-full">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="https://wisefi.vercel.app/" className="flex items-center">
                  <span className="self-center text-2xl font-black text-crema  whitespace-nowrap ">WiseFi</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 :text-gray-400 font-medium">
                      ...
                      <li>
                          <Link href="https://www.linkedin.com/in/mario-carcota/" className="hover:underline">Linkedin</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-verdeChiaro uppercase ">Legal</h2>
                  <ul className="text-gray-500 :text-gray-400 font-medium">
                      <li className="mb-4">
    ...
    {/*  <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <Link href="#" className="text-gray-500 hover:text-gray-90">

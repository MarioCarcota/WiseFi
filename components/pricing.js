...
export default function SlidePricing() {
  ...
  return (
    <section className="w-full mt-20 mb-20 bg-nero px-4 lg:px-8 py-12 lg:py-24 relative overflow-hidden">
...
const BackgroundShift = () => (
  <motion.span
    layoutId="bg-shift"
    className="absolute inset-0 bg-verdeChiaro rounded-lg -z-10"
  />
);
